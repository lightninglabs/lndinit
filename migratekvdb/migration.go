...
func (m *Migrator) withReadTx(db walletdb.DB,
	fn func(tx walletdb.ReadTx) error) error {
...
// withWriteTx executes a function within a read-write transaction
func (m *Migrator) withWriteTx(db walletdb.DB,
	fn func(tx walletdb.ReadWriteTx) error) error {
...
func (m *Migrator) markMigrationComplete(tx walletdb.ReadWriteTx) error {
	metaBucket, err := m.getOrCreateMetaBucket(tx)
	if err != nil {
...
func (m *Migrator) initMigrationState(ctx context.Context, targetDB walletdb.DB) error {
	return m.withWriteTx(targetDB, func(tx walletdb.ReadWriteTx) error {
...
func (m *Migrator) processNextChunk(ctx context.Context, sourceDB,
	...
	err := m.withReadTx(sourceDB, func(sourceTx walletdb.ReadTx) error {
		return m.withWriteTx(targetDB, func(targetTx walletdb.ReadWriteTx) error {
			// Process the chunk.
...
func (m *Migrator) VerifyMigration(ctx context.Context,
	...
	err := m.withReadTx(targetDB, func(tx walletdb.ReadTx) error {
...
func (m *Migrator) processVerificationChunk(ctx context.Context,
	...
	var moreChunks bool
	err := m.withWriteTx(targetDB, func(tx walletdb.ReadWriteTx) error {
